...
public class MMParser extends Parser {
	...
	public static class StartContext extends ParserRuleContext {
		...
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof MMListener ) ((MMListener)listener).enterStart(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof MMListener ) ((MMListener)listener).exitStart(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof MMVisitor ) return ((MMVisitor<? extends T>)visitor).visitStart(this);
